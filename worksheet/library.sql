...
ALTER TABLE LIBRARY DROP CONSTRAINT SYS_C007419;
ALTER TABLE LIBRARY ADD CONSTRAINT FK_BOOK_NO FOREIGN KEY(BOOK_NO) REFERENCES BOOK (BOOK_NO) ON DELETE SET NULL;
